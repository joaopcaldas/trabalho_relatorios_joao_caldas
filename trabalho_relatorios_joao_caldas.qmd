...
subtitle: "Análise Histórica e Projeções de 1930 a 2026"
author: "João Caldas"
...
<div class="header-container">
  <img src="img/logo_verao_ime_usp.png" class="logo-verao" alt="Logo Verão IME-USP">
  <div class="header-text">
    <h1 class="titulo-principal">Copa do Mundo FIFA 2026</h1>
    <p class="subtitulo-principal">Análise Histórica e Projeções de 1930 a 2026</p>
  </div>
</div>
:::
...
sedes_2014 <- coords %>% 
  filter(cidade %in% c("Rio de Janeiro", "Sao Paulo", "Belo Horizonte", 
                       "Brasilia", "Fortaleza", "Manaus", "Salvador",
                       "Recife", "Porto Alegre", "Curitiba", "Natal", "Cuiaba"))
...
# Sedes do Catar 2022
sedes_2022 <- coords %>% 
  filter(cidade %in% c("Lusail", "Doha", "Al Rayyan", "Al Wakrah", "Al Khor"))
